...
class ProductsManager(models.Manager):
    ...
    def search (self,query):
        ...
        return self.get_queryset().filter(lookup, active=True).distinct()  #distinct -> mavared tekrari ra pak mikonad
...
class Product(models.Model):
    ...
    categoris = models.ManyToManyField(ProductsCaregory, blank=True, verbose_name='دسته بندی ها')
